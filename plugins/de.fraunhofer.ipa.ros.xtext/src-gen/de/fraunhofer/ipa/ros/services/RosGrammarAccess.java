...
public class RosGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class CatkinPackageElements extends AbstractParserRuleElementFinder {
		...
		//'CatkinPackage'
		//name=RosNames
		//'{' ('Specs' '{' spec+=SpecBase ("," spec+=SpecBase)* '}')? (artifact+=Artifact ("," artifact+=Artifact)*)? ('Dependencies'
	...
	public class NodeElements extends AbstractParserRuleElementFinder {
		...
		//'name' name=RosNames ('ServiceServers' '{' serviceserver+=ServiceServer ("," serviceserver+=ServiceServer)* '}')? (
		//'Publishers' '{' publisher+=Publisher ("," publisher+=Publisher)* '}')? ('Subscribers' '{' subscriber+=Subscriber (","
		//subscriber+=Subscriber)* '}')? ('ServiceClients' '{' serviceclient+=ServiceClient ("," serviceclient+=ServiceClient)* '}'
		//)? ('ActionServers' '{' actionserver+=ActionServer ("," actionserver+=ActionServer)* '}')? ('ActionClients' '{'
		//actionclient+=ActionClient ("," actionclient+=ActionClient)* '}')? ('Parameters' '{' parameter+=Parameter (","
		//parameter+=Parameter)* '}')?
		//'}'
		public Group getGroup() { return cGroup; }
